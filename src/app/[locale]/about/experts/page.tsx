...
const pageText = {
  tr: {
    ...
    description: "Alanında uzman mühendis ve araştırmacılardan oluşan teknik ekibimiz.",
  },
  en: {
    subtitle: "About Us",
    title: "Our Expert Team",
    description: "Our technical team of expert engineers and researchers in their fields.",
  },
};
...
export default async function ExpertsPage({
  ...
  const members = await prisma.teamMember.findMany({
    where: { type: "expert", isActive: true },
    orderBy: { order: "asc" },
  });
      ...
      <section className="pt-4 pb-10 lg:pt-6 lg:pb-14 bg-white">
        <div className="mx-auto px-5 sm:px-8 lg:px-[6.5%]">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
            ...
            <AboutSidebar currentPath="/about/experts" />
          </div>
        </div>
      </section>
    </>
